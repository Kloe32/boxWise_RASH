...
import _PaymentMethods from  "./paymentMethods.js";
...
export default function initModels(sequelize) {
  ...
  const PaymentMethods = _PaymentMethods.init(sequelize, DataTypes);
  ...
  Payments.belongsTo(PaymentMethods, { as: "method", foreignKey: "method_id"});
  PaymentMethods.hasMany(Payments, { as: "payments", foreignKey: "method_id"});
  Bookings.belongsTo(StorageUnits, { as: "room", foreignKey: "room_id"});
  StorageUnits.hasMany(Bookings, { as: "bookings", foreignKey: "room_id"});
